...
def get_unanswered_questions_report(facultyid,courseid) :
	...
	try:    
		...
		discussion_coll = discussion_db.contents
		unans_ques = discussion_coll.find({"_type" : "CommentThread" , "thread_type" : "question" ,"course_id" : courseid, "comment_count" : 0} , {"_id" : 1,"body" : 1,"title" : 1,"commentable_id" : 1,"comment_count" : 1,"author_username" : 1})
