...
def email_details(request):
    ...
    return render_to_response('adminpanel/email_details.html',{'data':datalist[0],'page_no':datalist[1],'records_per_page':datalist[2],'max_page':datalist[3],'total_emails':datalist[4],'startdate':sd,'enddate':ed})
