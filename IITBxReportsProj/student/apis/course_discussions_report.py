...
def get_discussions_report(studentid,courseid) :

	try:    
		result=[]
		discussion_db = client.cs_comments_service_development
		discussion_coll = discussion_db.contents
		discussions =  discussion_coll.find({"_type" : "CommentThread" , "thread_type" : "discussion" ,"author_id" : studentid ,"course_id" : courseid}, {"_id" : 1,"body" : 1,"title" : 1,"commentable_id" : 1,"comment_count" : 1,"author_username" : 1})
